...
export const Route = createFileRoute("/auth")({
  ...
  head: () => ({
    meta: [
      { title: "Acesso administrativo — NextBR" },
      { name: "description", content: "Área de login do painel administrativo da NextBR." },
      { name: "robots", content: "noindex" },
      { property: "og:title", content: "Acesso administrativo — NextBR" },
      { property: "og:description", content: "Área de login do painel administrativo da NextBR." },
    ],
  }),
  component: AuthPage,
});
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-secondary/50 px-4">
      <div className="w-full max-w-md rounded-3xl bg-card p-8 shadow-elevated">
        <img src={logo} alt="Logo NextBR" className="mx-auto h-10 w-auto" />
